...
const searchHelper_1 = __importDefault(require("../../../helper/searchHelper"));
const index = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const objectSearch = (0, searchHelper_1.default)(req.query);
    ...
    const tasks = yield task_model_1.default.find(find).sort(sort).limit(objectPagination.limitItems)
